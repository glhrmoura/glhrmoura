...
export const Medium = ({ width = 28, color }: GithubProps) => {
  ...
  return (
    ...
    >
      <svg fill={color || theme.colors.text} width="100%" height="100%" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
