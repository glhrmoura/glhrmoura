export default {
  ...
  projects: {
    ...
    searchHub: {
      description: 'Entdecke Benutzer, erkunde Profile und Projekte in dieser intuitiven Suchanwendung.'
    },
    nubankWeb: {
    ...
    capital: {
      description: 'Anwendung zur einfachen und effizienten Verwaltung Ihrer Investitionen. Verfolgen Sie Ihre täglichen Investitionsaufzeichnungen, sehen Sie Diagramme und Analysen Ihrer Renditen und berechnen Sie monatliche Erträge automatisch. Alle Daten werden in der Cloud mit Firebase synchronisiert.'
    },
    cash: {
