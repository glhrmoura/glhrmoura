export default {
  ...
  projects: {
    ...
    noBeer: {
      ...
      description: 'A minimal and motivating app to help you track your alcohol-free journey. NoBeer counts the days since your last drink and keeps you focused on building healthier habits — one day at a time.',
      link: {
