export default {
  ...
  projects: {
    ...
    vueVirtualize: {
      description: 'A headless Vue 3 library for virtualizing lists, grids, and tables. It mounts only the items that intersect the viewport, so large collections stay fast.'
    },
    piano: {
